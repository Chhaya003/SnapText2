...
class ChooseUserActivity : AppCompatActivity() {
    ...
    var chooseUserLiistView : ListView ? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        chooseUserLiistView = findViewById(R.id.chooseUserListView)
        val adpater = ArrayAdapter(this, android.R.layout.simple_list_item_1, emails)
        chooseUserLiistView?.adapter = adpater
        ...
        chooseUserLiistView?.onItemClickListener = AdapterView.OnItemClickListener { parent, view, position, id ->
